...
public class FireTVService extends DeviceService implements MediaPlayer, MediaControl {
    ...
    private class FireTVServiceError extends ServiceCommandError {
        public FireTVServiceError(String error) {
            Log.e("ozvi - firetv error",error);
            throw new RuntimeException(error);
        }

        public FireTVServiceError(String errorMessage, Throwable cause) {
            Log.e("ozvi - firetv error: ",errorMessage);
            Log.e("ozvi - firetv cause: ",cause.getMessage());
